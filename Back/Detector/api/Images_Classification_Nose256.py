...
checkpoints_dir = settings.BASE_DIR+"/api/res/train_inception_v1_nose256_logs"
label_dir = settings.BASE_DIR+"/api/res/nose256_photos"
...
def evaluate(name):
    ...
    with tf.Graph().as_default():
        ...
        image_input = tf.read_file(settings.BASE_DIR+"/media/"+name+"/"+name+"_3.jpg")
        ...
        init_fn = slim.assign_from_checkpoint_fn(
            os.path.join(checkpoints_dir, 'model.ckpt-14355'),
