...
checkpoints_dir = settings.BASE_DIR+"/api/res/train_inception_v1_eyebrow256_logs"
label_dir = settings.BASE_DIR+"/api/res/eyebrow256_photos"
...
def evaluate(name):
    ...
    with tf.Graph().as_default():
        ...
        image_input = tf.read_file(settings.BASE_DIR+"/media/"+name+"/"+name+"_1.jpg")
        ...
        init_fn = slim.assign_from_checkpoint_fn(
            os.path.join(checkpoints_dir, 'model.ckpt-17518'),
